...
#
# vt52.tcl: Tcl script for re-creating project 'project_41'
#
# Generated by Vivado on Thu Jun 10 06:12:37 BST 2021
...
#
# 1. This project restoration tcl script (vt52.tcl) that was generated.
#
...
#
#    "/home/david/Documents/GitHub/djrm-vt52-fpga/char_buffer.v"
#    "/home/david/Documents/GitHub/djrm-vt52-fpga/char_rom.v"
#    "/home/david/Documents/GitHub/djrm-vt52-fpga/clock_generator.v"
...
set orig_proj_dir "[file normalize "$origin_dir/../../../../ebaz4205/projects/project_41"]"
...
set files [list \
 [file normalize "${origin_dir}/char_buffer.v"] \
 [file normalize "${origin_dir}/char_rom.v"] \
 [file normalize "${origin_dir}/clock_generator.v"] \
 ...
 [file normalize "${origin_dir}/mem/terminus_816_bold_latin1.mem"] \
 [file normalize "${origin_dir}/mem/empty.mem"] \
]
...
set file "$origin_dir/mem/terminus_816_latin1.mem"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Memory File" -objects $file_obj

set file "$origin_dir/mem/keymap.mem"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Memory File" -objects $file_obj

set file "$origin_dir/mem/terminus_816_bold_latin1.mem"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Memory File" -objects $file_obj

set file "$origin_dir/mem/empty.mem"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Memory File" -objects $file_obj
